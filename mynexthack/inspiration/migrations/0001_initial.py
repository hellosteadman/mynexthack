...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Idea'
        db.create_table(u'inspiration_idea', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sender', self.gf('django.db.models.fields.related.ForeignKey')(related_name='sent_ideas', to=orm['auth.User'])),
            ('recipient', self.gf('django.db.models.fields.related.ForeignKey')(related_name='received_ideas', to=orm['auth.User'])),
        ...
        db.send_create_signal(u'inspiration', ['Idea'])

        # Adding model 'Vote'
        db.create_table(u'inspiration_vote', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('idea', self.gf('django.db.models.fields.related.ForeignKey')(related_name='votes', to=orm['inspiration.Idea'])),
            ('voter', self.gf('django.db.models.fields.related.ForeignKey')(related_name='votes', to=orm['auth.User'])),
            ('value', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal(u'inspiration', ['Vote'])


    def backwards(self, orm):
        # Deleting model 'Idea'
        db.delete_table(u'inspiration_idea')

        # Deleting model 'Vote'
        db.delete_table(u'inspiration_vote')
